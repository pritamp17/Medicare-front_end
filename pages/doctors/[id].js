...
function home() {
  return(
    ...
    <Container className="shadow p-3 mb-5 my-4 bg-body rounded">
      <Row>
        <Col>
        <img src="C:\Users\91946\Downloads\FCjofIaVUAYMI-V.jp" alt="Dp"/>
        </Col> 
        <Col>
          <Card>
            <Card.Body>
              <Card.Header>Mrs prtiam pawar</Card.Header>
              <Card.Title className="my-2">MD in cheemology</Card.Title>
              <Card.Text>
                <p>
                  <ul>
                    <li>degree</li>
