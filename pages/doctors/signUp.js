        ...
        <Container className="border border-danger border-4">
          <Form className="my-5">
            ...
            <Row className="mb-3">
              ...
              <Form.Group as={Col} controlId="formGridSpec">
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridCity">
                ...
                <Form.Control type="text" placeholder="Allahabad" onChange={(e) => setCity(e.target.value)} />
              </Form.Group>
              ...
              <Form.Group as={Col} controlId="formGridState">
                ...
                <Form.Control type="text" placeholder="UP" onChange={(e) => setState(e.target.value)} />
              </Form.Group>

              <Form.Group as={Col} controlId="formGridZip">
                <Form.Label>Zip</Form.Label>
                <Form.Control type="text" placeholder="231220" onChange={(e) => setZip(e.target.value)} />
              </Form.Group>
            </Row>
